    ...
    <div class="card-body p-4">
        <form action="{{ route('fixtures.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    <label for="venue" class="form-label fw-bold">Match Venue Location</label>
                    <input type="text" class="form-control @error('venue') is-invalid @enderror" id="venue" name="venue" value="KUET Main Playground">
