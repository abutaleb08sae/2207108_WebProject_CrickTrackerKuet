        ...
        <form action="{{ route('players.store') }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('student_id') is-invalid @enderror" id="student_id" name="student_id" value="{{ old('student_id') }}" placeholder="e.g., 2001001">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('matches_played') is-invalid @enderror" id="matches_played" name="matches_played" value="{{ old('matches_played', 0) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('total_runs') is-invalid @enderror" id="total_runs" name="total_runs" value="{{ old('total_runs', 0) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('total_wickets') is-invalid @enderror" id="total_wickets" name="total_wickets" value="{{ old('total_wickets', 0) }}">
