        ...
        <form action="{{ route('players.update', $player->id) }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('matches_played') is-invalid @enderror" id="matches_played" name="matches_played" value="{{ old('matches_played', $player->matches_played) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('total_runs') is-invalid @enderror" id="total_runs" name="total_runs" value="{{ old('total_runs', $player->total_runs) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('total_wickets') is-invalid @enderror" id="total_wickets" name="total_wickets" value="{{ old('total_wickets', $player->total_wickets) }}">
